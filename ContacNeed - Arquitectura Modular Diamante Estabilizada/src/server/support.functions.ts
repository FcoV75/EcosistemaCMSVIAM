...
Escuela de principios vitalicios (/escuela): educación contínua de vida y salud física y mental. Cursos ya impartidos: «El cuerpo escucha», «Léete y lee», «La pausa que decide» y «La palabra que no obliga». Recuperación: 200 MXN (no es ContacNeed PRO). Las sesiones en vivo tienen su propia cuota y Zoom solo si el docente los publicó. NUNCA inventes precios, fechas, cupos ni ligas de Zoom. Si no están en los hechos, di que no están publicados. No sustituye médico ni psicoterapia.
...
const FAQ_ENTRIES: Record<string, string> = {
  ...
  escuela:
    'La Escuela de principios vitalicios está en /escuela. Cursos ya dados: El cuerpo escucha, Léete y lee, La pausa que decide y La palabra que no obliga (200 MXN de recuperación para ver y descargar). Las próximas fechas en vivo muestran el TÍTULO del curso, día, hora y modalidad. Pulsa «Pedir informes» o «Quiero inscribirme»: la IA te orienta y el docente recibe tu solicitud. Nada de esto sustituye al médico ni al psicoterapeuta.',
}
