...
export function RadioLauncher() {
  ...
  const handleOpen = () => {
    ...
    if (!opened) {
      alert(
        'No se pudo abrir la ventana de radio. Permite ventanas emergentes para este sitio e intenta de nuevo.',
      )
      return
    }
    setPopupOpen(true)
  ...
  return (
    <div className="cn-glass rounded-2xl border border-purple-500/20 p-4">
      ...
      <p className="mb-3 text-[11px] leading-relaxed text-purple-100/80">
        Abre la radio en una ventana pequeña aparte. Navega libremente por ContacNeed: el volumen, la
        estación y la reproducción no se interrumpen. Cierra la ventana para apagar.
      </p>
