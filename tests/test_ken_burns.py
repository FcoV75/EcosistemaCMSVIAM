...
class KenBurnsTests(unittest.TestCase):
    def test_zoom_in_empieza_abierto_y_cierra(self):
        bw, bh = int(WIDTH * 1.45), int(HEIGHT * 1.45)
    ...
    def test_progreso_ciclo_de_8s_se_nota(self):
        ...
        self.assertAlmostEqual(progreso_ken_burns(24 * 8, 24, 8), 1.0, places=5)
        self.assertAlmostEqual(progreso_ken_burns(24 * 16, 24, 8), 0.0, places=5)
        self.assertGreater(progreso_ken_burns(24 * 4, 24, 8), 0.4)
        self.assertLess(progreso_ken_burns(24 * 4, 24, 8), 0.6)
