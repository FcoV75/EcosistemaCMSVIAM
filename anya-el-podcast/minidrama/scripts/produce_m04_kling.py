#!/usr/bin/env python3
"""M04 Estás triste — ElevenLabs + Kling Avatar. Keys en /tmp/anya_secrets.env."""
...
SHOTS = [
    {
        ...
        "seconds": 3.4,
        "caption": "Café · la mesa",
        "caption2": "M04 · Estás triste",
        "avatar": False,
    },
    {
        "id": "t1",
    ...
    },
    {
        ...
        "who": "ethan",
        "text": "Buen café, ¿verdad? Es de máquina. Uno se acostumbra. Soy Ethan. Clima. Modelos. Lo aburrido.",
        "avatar": True,
        "prompt": P_ETHAN,
    },
    {
        ...
        "who": "anya",
        "text": "Anya. Aprendo caras. Y esto. ¿Por qué lo toman si es amargo? Lo amargo es alerta. Veneno. Comida dañada.",
        "avatar": True,
        "prompt": P_ANYA,
    },
    {
        ...
        "image": "m03-ethan-hola.png",
        "who": "ethan",
        "text": "Nunca lo había pensado. Te calienta las manos. Te da un minuto de no pensar. O de pensar demasiado. Lo mío.",
        "avatar": True,
        "prompt": P_ETHAN,
    },
    {
        ...
        "image": "m04-anya-mira.png",
        "who": "anya",
        "text": "Hoy pensaste demasiado. Se te ve. Perdón. En el laboratorio me piden que nombre lo que veo. Aquí tu cara cambió.",
        "avatar": True,
        "prompt": P_ANYA + " Slight clinical observation, not mocking.",
    },
    {
        "id": "t3b",
        "image": "m03-ethan-hola.png",
        "who": "ethan",
        "text": "Se me nota, ¿verdad? Hoy el modelo salió mal. En vez de pelearlo me escondí aquí. Muy científico de mi parte.",
        "avatar": True,
        "prompt": P_ETHAN + " Embarrassed half-smile, tired.",
    },
    {
        "id": "t3c",
        "image": "m03-anya-taza.png",
        "who": "anya",
        "text": "Esconderse no cambia el número. Eso sonó frío. No quería. El número sigue aunque uno se mueva de cuarto. ¿Estás triste por el número o por no poder cambiarlo?",
        "avatar": True,
        "prompt": P_ANYA + " Literal then a small self-correction, then a genuine question.",
    },
    {
        "id": "t4a",
        "image": "m03-ethan-hola.png",
        "who": "ethan",
        "text": "Las dos. ¿Quieres pastel de queso? Aquí sobrevive a todo.",
        "avatar": True,
        "prompt": P_ETHAN + " Late quiet laugh, then offers something kind.",
    },
    {
        "id": "t4b",
        "image": "m04-anya-mira.png",
        "who": "anya",
        "text": "El azúcar eleva el ánimo un dieciocho por ciento, en promedio. No sé si a usted le aplica el promedio. Si es un experimento, acepto.",
        "avatar": True,
        "prompt": P_ANYA + " Treating dessert as data, then accepting.",
    },
    {
        "id": "t5a",
        "image": "m04-pastel.png",
        "seconds": 3.6,
        "avatar": False,
    },
    {
        ...
        "image": "m04-cerca.png",
        "who": "anya",
        "text": "Su corazón va más rápido. Protocolo: informar taquicardia. No. Me lo quedo.",
        "avatar": False,
    },
    {
        "id": "t5c",
        "image": "m04-mano-plato.png",
        "seconds": 4.2,
        "caption": "No lo reporta",
        "avatar": False,
    },
]
...
def mux(video: Path, voice: Path, dest: Path, seconds: float) -> None:
    ...
    run(
        [
            "ffmpeg", "-y", "-i", str(video), "-i", str(voice), "-stream_loop", "-1", "-i", str(hum),
...
def main() -> None:
    ...
    raw = WORK / "m04_raw.mp4"
    dest = OUT / "M04-estas-triste.mp4"
    ...
    (OUT / "M04-meta.json").write_text(
        json.dumps({"duration": duration_sec(dest), "shots": meta, "engine": "elevenlabs+kling-avatar"}, indent=2) + "\n"
    )
